...
$sub_sql = " where payment < total_bill";
$c_name = "";
$toDate = $fromDate = "";
if (isset($_POST['name11'])) {
    ...
    if (!empty($_POST['c_name']) && empty($_POST['from']) && !isset($_POST['chekbox'])) {
        ...
        $sub_sql = " where $c_name && payment < total_bill";
    } elseif (!empty($_POST['c_name']) && !empty($_POST['from']) && empty($_POST['chekbox'])) {
        $name = $_POST['c_name'];
        $chek = 0;
        $sub_sql = " where selling_product.customer = '$name' && date >= '$from' && date <= '$to' && payment < total_bill";
    } elseif (isset($_POST['chekbox']) && !empty($_POST['c_name'])) {
        $name = $_POST['c_name'];
        $chek = 0;
        $sub_sql = " where selling_product.payment = '$chek' && selling_product.customer = '$name' || payment < total_bill && selling_product.customer = '$name'";
    } elseif (isset($_POST['chekbox']) && empty($_POST['c_name']) && empty($_POST['from'])) {
        $chek = 0;
        $sub_sql = " WHERE payment = '$chek' && payment < total_bill";
    } else {
        $name = $_POST['c_name'];
        $chek = 0;
...
<body>
  <div class="container">
    <form action="./zero_payment.php?page=<?php echo $page; ?>" method="post">
      ...
      <div class="row">
        ...
        <div class="col-6">
          <form action="./zero_payment.php?page=<?php echo $page; ?>" method="post" class=" d-flex justify-content-center md-form form  active-cyan-2 mb-2">
            <!-- ############################################################################ -->
            <div class="">
        ...
        <tbody>
          ...
          ?>
              <tr>
                ...
                <td data-label="Fix price"><?php echo $fix_price; ?></td>
                <td data-label="Credit"><?php echo $credit; ?></td>
                <td data-label="Debit"><?php echo $debit; ?></td>
                <td data-label="Payment"><?php echo $payment; ?></td>
                <td data-label="Bill"><?php echo $bill; ?></td>
                <td data-label="left_pament"><?php echo $left_pament; ?></td>
              </tr>
            <?php
            }
      ...
      ?>
        <nav aria-label="Page navigation example">
          <ul class="pagination">
            ...
            ?>
                <li class="page-item">
                  <a class="page-link" href="./zero_payment.php?page=<?php echo $page - 1; ?>" aria-label="Previous">
              ...
              ?>
                ...
                <li class="page-item"><a class="page-link" href="./zero_payment.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
              <?php
              }
              if ($total_page > $page) {
              ?>
                <li class="page-item">
                  <a class="page-link" href="./zero_payment.php?page=<?php echo $page + 1; ?>" aria-label="Next">
